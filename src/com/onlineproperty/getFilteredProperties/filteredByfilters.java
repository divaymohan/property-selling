...
public class filteredByfilters {
	propertyPOJO pPojo;
	...
	public List<getPropertiespojo> getProperties(getFilteredPropertiesPOJO getFilPojo){
		
		try {
			List<propertyPOJO> pList = new ArrayList<propertyPOJO>();
			propertyDAO proDao = new propertyDAO();
			pList = proDao.getFilteredProperty(getFilPojo.getPropertyType());
