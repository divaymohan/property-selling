...
import com.onlineproperty.DAOS.*;
import com.onlinepropertysell.pojos.*;
import com.sun.org.apache.xml.internal.serializer.ElemDesc;

public class getSellerProperties {
	propertyPOJO pPojo;
	...
	public List<getPropertiespojo> getProperties(int sellerId, int userId){
		
		try {
			List<propertyPOJO> pList = new ArrayList<propertyPOJO>();
			propertyDAO proDao = new propertyDAO();
			pList = proDao.getProperty(sellerId);
